(function(){
    ...
    uniformContract.factory("contractService", ["$http", "contextServer", function ($http, contextServer) {

        function getContractPage(queryObj, callback, errorCallback) {
        	$http.jsonp(contextServer + "/ct/paas/us/commonresource/getContract.do?callback=JSON_CALLBACK", {
                params: {
    ...
    uniformContract.directive("searchContractDialog", ["contextServer", function (contextServer) {
