...
<div modal-dialog
    ...
    <div>
        ...
        <button ng-click="reloadTree()" type="button" class="btn btn-default"><i class="fa fa-search"></i>查找</button>
    </div>
    ...
    <div class="tab-content" style="border:1px solid #e1e1e1; border-top:0;">
    	...
    	<div role="tabpanel" class="tab-pane" ng-class="{'active': treeDialogView.all}">
	    	<div class="tree-dialog" role="{{modalTitle}}" onselectstart="return false;">
		        ...
		        <ol style="height: 222px; overflow: auto; font-size: 16px; margin-left: 0px;padding:10px 0 0;margin-bottom:0;">
		            <li ng-repeat="node in nodes" ng-include="contextServer + '/ct/js/tpl/tree.node.forSearchingUsers.jsp'"></li>
		        </ol>
