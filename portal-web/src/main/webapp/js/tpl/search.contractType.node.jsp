...
<ol style="list-style: none;-webkit-padding-start: 20px;margin:0;font-family:'å®ä½';font-size:14px;line-height:26px;" >
    <li ng-repeat="node in nodes | filter: {name: treeDialogView.filterField}" ng-if="isShown(node)" >
